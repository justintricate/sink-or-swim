...
def show_predict_page():
    ...
    st.write('The sinking of the RMS Titanic is the deadliest peacetime maritime disaster to date, and resulted in the loss of over 1500 people. Using machine learning, we can predict whether *you* would sink or swim.')
